...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- it can fuzzy find! It's more than ,ust a "file finder", it can search
...
-- vim.keymap.set('n', '<Leader>ht1', require('harpoon.term').gotoTerminal(1))
-- vim.keymap.set('n', '<Leader>ht2', require('harpoon.term').gotoTerminal(2))
-- vim.keymap.set('n', '<Leader>ht3', require('harpoon.term').gotoTerminal(3))
-- vim.keymap.set('n', '<Leader>ht4', require('harpoon.term').gotoTerminal(4))
-- vim.keymap.set('n', '<Leader>ht5', require('harpoon.term').gotoTerminal(5))
-- vim.keymap.set('n', '<Leader>ht6', require('harpoon.term').gotoTerminal(6))

vim.keymap.set('n', '<Leader>hxx', function()
  harpoon:list():add()
end)
vim.keymap.set('n', '<Leader>hnn', function()
  harpoon:list():next()
end)
vim.keymap.set('n', '<Leader>hpp', function()
  harpoon:list():prev()
end)
vim.keymap.set('n', '<Leader>hmm', ':Telescope harpoon marks<CR>')
-- vim.keymap.set('n', '<Leader>hn', require('harpoon.ui').nav_next)
-- vim.keymap.set('n', '<Leader>hp', require('harpoon.ui').nav_prev)
-- vim.keymap.set('n', '<Leader>hm', ':Telescope harpoon marks<CR>')
-- vim.keymap.set('n', '<Leader>ht1', require('harpoon.term').gotoTerminal(1))
